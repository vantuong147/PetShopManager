...
public class PetDAO {
    ...
    public void addPet(Pet pet) {
        String query = "INSERT INTO Pet (pet_name, price, age, color, description, state, pet_species_id) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    public void updatePet(Pet pet) {
        String query = "UPDATE Pet SET pet_name = ?, price = ?, age = ?, color = ?, description = ?, state = ?, pet_species_id = ? WHERE id = ?";
        try (Connection connection = DBConnection.getConnection();
